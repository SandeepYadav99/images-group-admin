...
import AwardCategories from "../../Create/PrivilegeAwardCategories/PrivilegeAwardCategoriesCreate";
import AwardCategoriesCreate from "../../Create/PrivilegeAwardCategories/PrivilegeAwardCategoriesCreate";
    ...
    <div>
      ...
      >
        <div className={styles.header_paper}>
          <p>
            <b>Membership Categories Eiligibility</b>
          </p>
      ...
      <SidePanelComponent
        ...
        title={`${selectedData?.id ? 'Update' : 'Add'} Membership Category` }
        open={isSidePanel}
        side={"right"}
      >
