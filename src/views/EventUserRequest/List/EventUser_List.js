...
import AcceptDialog from "../Component/AcceptPopUp/AcceptDialog.List"
import StatusPill from "../../../components/Status/StatusPill.component";
import useEventUserHook from "./EventUser_hook";
...
const EventUserList = ({ }) => {
  ...
  } = useSelector((state) => state.event_userRequest);
  ...
  }, [renderStatus, handleEdit, isCalling,handleAcceptData,dataValue]);
    ...
    <div>
      <PageBox>
        <div className={styles.headerContainer}>
          <div>
            <span className={styles.title}>Event Users Request</span>
